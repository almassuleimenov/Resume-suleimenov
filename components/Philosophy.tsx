...
const principles = [
  {
    ...
    description: "Я не просто 'пишу код по ТЗ'. Я думаю как фаундер: анализирую бизнес-логику, удобство пользователей (UX) и экономику проекта до написания первой строчки кода.",
    number: "01"
  },
  {
    title: "AI-First Подход",
    description: "Там, где другие пишут тысячи строк кода, я внедряю нейросети (LLaMA, RAG-архитектуры). Это экономит бизнесу месяцы разработки и дает магический результат.",
    number: "02"
  },
  {
    title: "Оптимизация O(N)",
    description: "Красивый интерфейс бессмысленен, если сервер падает от нагрузки. Я строю отказоустойчивые микросервисы на Go и Python, готовые к масштабированию.",
    number: "03"
  }
];
